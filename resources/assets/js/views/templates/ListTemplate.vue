...
export default {
  ...
  props: [
     "items", "fields", "showAction", "editAction", "addAction", "deleteAction"
  ],
  ...
  methods: {
    info (item) {  
      this.affiliation_row = JSON.stringify(item, null, 2);
      this.affiliation_id = item['id']; 
      window.location.href = '/affiliation-show/' + this.affiliation_id;    
    },
